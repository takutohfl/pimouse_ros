...
from std_srvs.srv import Trigger, TriggerResponse #追記部分
from pimouse_ros.srv import TimedMotion #追記2
...
class Motor():
    def __init__(self):
        ...
        self.srv_on = rospy.Service('motor_on', Trigger, self.callback_on) #追記部分
        self.srv_off = rospy.Service('motor_off', Trigger, self.callback_off) #追記部分
    ...
    def onoff_response(self,onoff): #追加部分↓
        d = TriggerResponse()
