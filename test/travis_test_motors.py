...
from pimouse_ros.srv import TimedMotion #追加2

class MotorTest(unittest.TestCase):
    def setUp(self): #追加
        rospy.wait_for_service('/motor_on')
        rospy.wait_for_service('/motor_off')
        rospy.wait_for_service('/timed_motion') #追加2
    ...
    def test_on_off(self):
        ...
        self.assertEqual(ret.message, "OFF", "motor on wrong message")
    ...
    def test_put_value_timed(self): #追加2
...
if __name__ == '__main__': #sleepの行を削除
