#!/usr/bin/env python
#encoding: utf8 日本語設定
import rospy, unittest, rostest, actionlib #actionlibを追加
import rosnode
import time
from std_msgs.msg import UInt16
from pimouse_ros.msg import MusicAction, MusicResult, MusicFeedback, MusicGoal #追加項目


class BuzzerTest(unittest.TestCase):
 def setUp(self): #setUpの追記
     self.client = actionlib.SimpleActionClient("music", MusicAction)
     self.device_values = []  #デバイスファイルに書き出された値の採取リスト
